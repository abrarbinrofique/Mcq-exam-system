"""
Django settings for nvt project.
...
SECRET_KEY = 'django-insecure-#f7cn7zj%&djc$d01)712s$z-_r!7z=1lbwnx2)vn@i70%vjgs'
...
WSGI_APPLICATION = 'nvt.wsgi.application'
